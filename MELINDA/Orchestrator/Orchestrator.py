...
parser.add_argument("--FPS", help="The total of FPS generated by the camera.", type=str)
parser.add_argument("--MQTT_HOST", help="IP where the message broker MQTT is running. Example: localhost.", type=str)
parser.add_argument("--MQTT_PORT", help="PORT where the message broker MQTT is running. Example: 1883.", type=str)
...
msg = subscribe.simple(args.MQTT_TOPIC_NODES, hostname=args.MQTT_HOST, port=args.MQTT_PORT)
...
workflow_fps_demand = int(args.FPS)
