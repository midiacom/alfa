...
./udp_flex -P 6001 -R http://rest-api:3000/vms/monitor &
...
./udp_flex -ch 127.0.0.1 -cp 6001 -mh mosquitto -mt ${spo_array[3]} -hs ${spo_array[2]} -id ${spo_array[3]} ${spo_array[0]} ${spo_array[1]}