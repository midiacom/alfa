# ALFA a V-PRRISM Implementation
...
V-PRISM is an architecture to create VMS. VMSs are Virtual Multimedia Sensors, they are used to improve features from real multimedia devices. A VMS Camera can be used to delivery images in many formats that it's physical hardware device can't. For example, the image below was generated by a color stream data.

<img src="docs/example_grey.png" width="50%">

The device only generate data in full RGB mode but the VMS can be programable to delivery data in any format.
